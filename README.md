# 🌌 ALGO3D — Interactive 3D Data Structures & Algorithms Laboratory

**ALGO3D** is an interactive, cinematic 3D operating environment for exploring, debugging, benchmarking, and learning Data Structures & Algorithms.
...
- **Procedural Web Audio Engine**: Harmonious, non-intrusive harmonic micro-synthesis for algorithm operations.
- **Global Command Palette (`Ctrl+K` / `Cmd+K`)**: Fast natural language commands (`> compare quick merge`, `> jump 25`, `> speed 2x`, `> debug on`).
...
- **Styling**: Vanilla CSS (Dark OLED Design System)
